...
public class SetGame extends JPanel implements ActionListener {
    ...
    public static void setInte(int inputvalue) {
        bebe = inputvalue;
    }
    ...
    private void doDrawing(Graphics g) {
        if (inGame) {
            ...
            g.setColor(Color.white);
            g.setFont(new Font("Havatica", Font.BOLD,14));
            g.drawString("Goal: " + bebe,190,B_HEIGHT-20);
